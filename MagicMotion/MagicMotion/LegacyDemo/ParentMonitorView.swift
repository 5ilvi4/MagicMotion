...
// MagicMotion — LEGACY DEMO (external display surface)
//
// Shown on the external HDMI/AirPlay screen via ExternalDisplayManager.
// Currently depends on GameSession for score/distance/state metrics.
//
// Technical debt: GameSession dependency makes this a legacy-demo view.
// Needs to be replaced with a ControllerSession-aware monitor view before
// the external display path is canonical for MagicMotion Home.
//
// DO NOT wire ControllerSession features here.
// Instead, create HomeMonitorView accepting ControllerSession when ready.
