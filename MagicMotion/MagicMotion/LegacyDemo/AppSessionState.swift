...
//
// Early-draft app-level state machine: CalibrationState, TrackingState, AppSessionState.
// This is NOT part of the MagicMotion Home controller runtime.
//
// Never wired into ContentView. Only consumed by GameViewModel (also legacy demo).
// Can be deleted together with GameViewModel.swift.
