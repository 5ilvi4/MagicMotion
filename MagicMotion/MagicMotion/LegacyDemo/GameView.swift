...
//
// Endless-runner demo game UI. Consumes GameSession.
// This is NOT part of the MagicMotion Home controller runtime.
//
// Kept temporarily because ContentView's fallback debug layout embeds it.
// Once the fallback layout is replaced with Home UI, this file can be deleted.
