...
//
// Data models for the endless-runner demo game: Player, Obstacle, Coin, GameState.
// This is NOT part of the MagicMotion Home controller runtime.
//
// Kept because GameSession and GameView depend on these types.
// Delete together with GameSession.swift and GameView.swift.
